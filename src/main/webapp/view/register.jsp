...
<body>
 <div class="navbar">
            ...
            <a href="/index"><span class="material-icons">home</span></a>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                       <h3 style="align-self: flex-start; padding: 10px 0px;">User SignUp</h3>
      <form action="/user_signup_2" method="POST">
      ...
      <p style="padding: 10px;">Already have an account? <a href="/user_signin" style="color: #4285f4;">Login</a></p>
                    </div>
                    <div class="signup-image">
                        
                        <a href="/user_signin" class="signup-image-link">I already have an account</a>
                    </div>
                </div>
            </div>
        </section>
